package com.robbie.backend.front.controller.cheatmeal;

import com.robbie.backend.front.api.cheatmeal.createcheatmeal.CreateCheatMealItemPresentation;
import com.robbie.backend.front.api.cheatmeal.createcheatmeal.model.CreateCheatMealItemRequest;
import com.robbie.backend.front.api.cheatmeal.createrecord.CreateRecordPresentation;
import com.robbie.backend.front.api.cheatmeal.createrecord.model.CreateRecordRequest;
import com.robbie.backend.front.api.cheatmeal.deletecheatmealitem.DeleteCheatMealItemPresentation;
import com.robbie.backend.front.api.cheatmeal.getSettingData.GetSettingDataPresentation;
import com.robbie.backend.front.api.cheatmeal.getSettingData.model.GetSettingDataResponse;
import com.robbie.backend.front.api.cheatmeal.getbudget.GetBudgetPresentation;
import com.robbie.backend.front.api.cheatmeal.getbudget.model.GetBudgetResponse;
import com.robbie.backend.front.api.cheatmeal.getcheatmeals.GetCheatMealsPresentation;
import com.robbie.backend.front.api.cheatmeal.getcheatmeals.model.GetCheatMealsResponse;
import com.robbie.backend.front.api.cheatmeal.getconsumptionrecord.GetConsumptionRecordPresentation;
import com.robbie.backend.front.api.cheatmeal.getconsumptionrecord.model.GetConsumptionRecordResponse;
import com.robbie.backend.front.api.cheatmeal.updatebudget.UpdateUserBudgetPresentation;
import com.robbie.backend.front.api.cheatmeal.updatebudget.model.UpdateUserBudgetRequest;
import com.robbie.backend.front.api.cheatmeal.updatecheatmeal.UpdateCheatMealItemPresentation;
import com.robbie.backend.front.api.cheatmeal.updatecheatmeal.model.UpdateCheatMealItemRequest;
import com.robbie.backend.front.api.cheatmeal.updateusername.UpdateUserNamePresentation;
